...
import (
	...
	"github.com/sayeed1999/ride-sharing-golang-api/internal/modules/trip/repository/mocks"
...
func TestCustomerCancelTrip_Execute(t *testing.T) {
	...
	// TODO: This test is buggy since the middleware already checks for customer ID match
