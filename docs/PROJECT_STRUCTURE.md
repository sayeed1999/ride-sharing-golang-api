...
│
├── services/                          # Each service = potential microservice
│   │
│   ├── auth/                          # AUTH SERVICE (Generic, reusable)
│   │   ├── domain/
│   │   │   ├── user.go
│   │   │   ├── role.go
│   │   │   ├── user_role.go
...
│   │   │       └── role_repo.go
│   │   ├── service/
│   │   │   └── auth_service.go        # PUBLIC API (exposed to other services)
...
│   │   │       └── auth.proto
│   │   └── module.go                  # Service initialization
│   │
│   ├── rider/                         # RIDER SERVICE (Customer operations + Trip requests)
│   │   ├── domain/
...
│   │   └── module.go
│   │
│   ├── driver/                        # DRIVER SERVICE (Driver operations + Trip fulfillment)
│   │   ├── domain/
│   │   │   ├── driver.go
│   │   │   ├── availability.go
│   │   │   ├── vehicle.go
...
│   │   └── module.go
│   │
│   ├── trip-processing/               # TRIP PROCESSING SERVICE (Core algorithms - internal only)
│   │   ├── domain/
...
│   │   ├── api/
│   │   │   └── events/                # NO HTTP/GraphQL - event-driven only
...
├── docs/
│   ├── architecture.md
│   ├── service-contracts.md           # Service interface documentation
